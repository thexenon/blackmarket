package com.optyxenon.blackmarket.ui.adapters
...
import com.optyxenon.blackmarket.databinding.VerticalProductLayoutBinding
import com.optyxenon.blackmarket.ui.adapters.ProductsAdapter.ViewHolder
import java.util.*

class ProductsAdapter(private val onClickListener: OnClickListener) :
    ListAdapter<Product, ViewHolder>(MyDiffUtil) {
    ...
    inner class ViewHolder(val binding: VerticalProductLayoutBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            VerticalProductLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false)
