package com.optyxenon.blackmarket.utilities
...
object VisualUtils {
    ...
    fun calculateNoOfColumns(
        ...
        columnWidthDp: Float,
        spacing: Int
    ): Int { // For example column Width = 180 dp + 16 dp margins
        val displayMetrics = context.resources.displayMetrics
        val screenWidthDp = displayMetrics.widthPixels / displayMetrics.density
        val numberOfColumns = (screenWidthDp / (columnWidthDp + spacing)).toInt()
    ...
    class SpacingItemDecoration(private val mSizeGridSpacingPx: Int, private val mGridSize: Int) :
        ItemDecoration() {
